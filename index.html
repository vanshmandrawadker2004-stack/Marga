        ...
        <nav class="fixed top-0 w-full z-50 transition-all duration-300 ease-in-out bg-[#050507]">
            <div class="flex justify-between items-center h-20 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto border-b border-white/5" style="border-image: linear-gradient(to right, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 50%, transparent 100%) 1;">
                ...
                <div class="hidden md:flex items-center">
                    ...
                    <div id="gateway-user-menu" class="dropdown-container relative flex items-center gap-3 bg-[#111113] border border-white/5 pl-4 pr-1.5 py-1.5 rounded-[24px] hover:bg-white/5 transition-colors cursor-pointer shadow-lg">
                        ...
                        <div class="dropdown-menu" style="right: 0; left: auto; top: 120%; padding: 20px; width: 280px; background: #111113; border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.8);">
                            <div id="gateway-profile-name" style="font-size: 20px; font-weight: 700; color: #fff; margin-bottom: 4px;">Guest Rider</div>
                            <div id="gateway-profile-tag" style="color: #00f0ff; font-size: 11px; margin-bottom: 24px; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px;">Preview Mode</div>
                            
                            <button onclick="window.launchApp()" style="width: 100%; background: #00f0ff; color: #000; padding: 14px; border: none; border-radius: 10px; font-size: 13px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; cursor: pointer; transition: transform 0.2s;">Enter Map</button>
                            
                            <button id="gateway-logout-btn" style="width: 100%; background: transparent; border: 1px solid rgba(255,255,255,0.2); color: #aaa; padding: 14px; border-radius: 10px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.background='rgba(255,255,255,0.05)'; this.style.color='#fff';" onmouseout="this.style.background='transparent'; this.style.color='#aaa';">Sign Out</button>
                        </div>
                    </div>
                </div>
