...
const allTrails = [
    ...
    // ==========================================
    {
        ...
        category: "Mountain",
        vibeType: "Twisties",
        description: "The legendary gateway to Wayanad. 9 sharp, intense hairpins climbing rapidly through deep fog and monkey-filled forests.",
        latitude: 11.4988,
        longitude: 76.0125,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Mountain",
        vibeType: "Twisties",
        description: "Immaculate, sweeping black tarmac cutting through blindingly green tea estates. The air gets incredibly crisp up here.",
        latitude: 10.0889,
        longitude: 77.0595,
        petrolPump: true,
    ...
    },
    {
        ...
        category: "Coastal",
        vibeType: "Chill",
        description: "The longest drive-in beach in Asia. 4 kilometers of hard-packed sand where you can safely ride your motorcycle right on the shoreline.",
        latitude: 11.7923,
        longitude: 75.4526,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "Chill",
        description: "A surreal, misty road winding through towering pine forests and endless rolling meadows. Perfect for a relaxed evening cruise.",
        latitude: 9.6841,
        longitude: 76.9034,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Mountain",
        vibeType: "Twisties",
        description: "A beautifully paved, fast-paced ascent featuring exactly 22 hairpins. A favorite weekend run for local sportbike riders.",
        latitude: 8.7599,
        longitude: 77.1169,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Scenic",
        vibeType: "Chill",
        description: "Ride through the rice bowl of Kerala. A narrow, perfectly flat ribbon of road with water channels and houseboats on both sides.",
        latitude: 9.4312,
        longitude: 76.3804,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Mountain",
        vibeType: "OffRoad",
        description: "An incredibly steep, narrow, and broken path leading up to a massive rock formation. Requires serious momentum and clutch control.",
        latitude: 9.7348,
        longitude: 76.8188,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "OffRoad",
        description: "A heavily restricted, pristine eco-tourism trail. Mud, gravel, thick tree canopies, and high chances of spotting wild elephants.",
        latitude: 9.4357,
        longitude: 77.1648,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "Highway",
        description: "A beautifully shaded stretch of road cutting through the Sholayar Reserve Forest leading to Kerala's most famous waterfall.",
        latitude: 10.2851,
        longitude: 76.5694,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "Chill",
        description: "A highly aromatic, winding road passing straight through the only natural sandalwood forest in Kerala.",
        latitude: 10.2741,
        longitude: 77.1593,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Coastal",
        vibeType: "Chill",
        description: "A relaxed, low-speed road tracing the top of the famous red laterite cliffs with sweeping views of the Arabian Sea.",
        latitude: 8.7378,
        longitude: 76.7163,
        petrolPump: true,
    ...
    },
    {
        ...
        category: "Mountain",
        vibeType: "Twisties",
        description: "Wide, sweeping corners leading to one of the highest arch dams in Asia. Excellent tarmac and stunning reservoir views.",
        latitude: 9.8433,
        longitude: 76.9744,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Mountain",
        vibeType: "Twisties",
        description: "A lesser-known gem featuring 10 hairpin bends. Ascends quickly from the hot plains into cool, mist-covered orange and tea estates.",
        latitude: 10.5361,
        longitude: 76.6845,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Coastal",
        vibeType: "Highway",
        description: "A clean, straight stretch of highway right along the northern Kerala coastline leading up to the massive, historic Bekal Fort.",
        latitude: 12.3948,
        longitude: 75.0347,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "OffRoad",
        description: "A rugged dirt and broken-tarmac track leading into a tiger reserve. True off-grid riding with bamboo thickets on both sides.",
        latitude: 10.3927,
        longitude: 76.7758,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "Highway",
        description: "The road dropping down from Munnar into the dry plains. Fast corners and incredible views of the rain-shadow region.",
        latitude: 10.3012,
        longitude: 77.2625,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "OffRoad",
        description: "Remote, unpaved logging trails skirting the edge of India's most pristine tropical evergreen forest.",
        latitude: 11.1354,
        longitude: 76.4326,
        petrolPump: false,
        images: []
    },
    {
        ...
        category: "Coastal",
        vibeType: "Highway",
        description: "A fast, scenic coastal strip where the Arabian Sea crashes against the rocks right next to the tarmac.",
        latitude: 11.5167,
        longitude: 75.6667,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Mountain",
        vibeType: "Chill",
        description: "A cold, high-altitude road riding past the Periyar tiger reserve borders into small, privately owned spice and fruit orchards.",
        latitude: 9.6053,
        longitude: 77.1659,
        petrolPump: true,
        images: []
    },
    {
        ...
        category: "Forest",
        vibeType: "OffRoad",
        description: "A deep, muddy forest track cutting into the Neyyar Wildlife Sanctuary. Only recommended for ADV bikes with good ground clearance.",
        latitude: 8.6186,
        longitude: 77.2458,
        petrolPump: false,
        images: []
