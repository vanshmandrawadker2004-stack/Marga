...
const allTrails = [
    ...
    // ==========================================
    {
        locationName: "Rann of Kutch Salt Flats",
        anchorCity: "Bhuj",
        category: "Scenic",
        vibeType: "Highway",
    ...
    {
        locationName: "Mount Abu Hairpins",
        anchorCity: "Abu Road",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Longewala Desert Highway",
        anchorCity: "Jaisalmer",
        category: "Scenic",
        vibeType: "Highway",
    ...
    {
        locationName: "Gir National Park Periphery",
        anchorCity: "Sasan Gir",
        category: "Forest",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Dholavira Island Road",
        anchorCity: "Rapar",
        category: "Lake",
        vibeType: "Highway",
    ...
    {
        locationName: "Kumbhalgarh Forest Pass",
        anchorCity: "Kumbhalgarh",
        category: "Forest",
        vibeType: "Twisties",
    ...
    {
        locationName: "Dwarka Coastal Highway",
        anchorCity: "Dwarka",
        category: "Coastal",
        vibeType: "Highway",
    ...
    {
        locationName: "Sambhar Salt Lake Off-Grid",
        anchorCity: "Sambhar",
        category: "Lake",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Statue of Unity Approach",
        anchorCity: "Kevadia",
        category: "Scenic",
        vibeType: "Highway",
    ...
    {
        locationName: "Polo Forest Trails",
        anchorCity: "Idar",
        category: "Forest",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Sam Sand Dunes Track",
        anchorCity: "Jaisalmer",
        category: "Desert",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Narayan Sarovar Route",
        anchorCity: "Lakhpat",
        category: "Lake",
        vibeType: "Chill",
    ...
    {
        locationName: "Haldighati Historic Pass",
        anchorCity: "Nathdwara",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Little Rann Wild Ass Sanctuary",
        anchorCity: "Dasada",
        category: "Desert",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Barmer Border Highway",
        anchorCity: "Barmer",
        category: "Scenic",
        vibeType: "Highway",
    ...
    {
        locationName: "Mandvi Beach Strip",
        anchorCity: "Mandvi",
        category: "Coastal",
        vibeType: "Chill",
    ...
    {
        locationName: "Garadia Mahadev Canyon",
        anchorCity: "Kota",
        category: "Scenic",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Ranakpur Valley Road",
        anchorCity: "Ranakpur",
        category: "Forest",
        vibeType: "Chill",
    ...
    // ==========================================
    {
        ...
        longitude: 77.6047,
        petrolPump: false,
        cafe: "Highest Cafeteria in the World",
        images: []
    },
    {
        locationName: "Zoji La Pass",
        anchorCity: "Sonamarg",
        category: "Mountain",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Pangong Tso Approach",
        anchorCity: "Lukung",
        category: "Lake",
        vibeType: "Chill",
    ...
    {
        locationName: "Nubra Valley Sand Dunes",
        anchorCity: "Hunder",
        category: "Desert",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Magnetic Hill Highway",
        anchorCity: "Leh",
        category: "Scenic",
        vibeType: "Highway",
    ...
    {
        locationName: "Kunzum Pass (Spiti)",
        anchorCity: "Kaza",
        category: "Mountain",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Rohtang Pass Curves",
        anchorCity: "Manali",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Pangi Valley Cliffhanger",
        anchorCity: "Killar",
        category: "Mountain",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Mana Pass",
        anchorCity: "Badrinath",
        category: "Mountain",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Munsiyari Ghats",
        anchorCity: "Pithoragarh",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Chopta-Tungnath Route",
        anchorCity: "Ukhimath",
        category: "Forest",
        vibeType: "Chill",
    ...
    {
        locationName: "Auli Snow Road",
        anchorCity: "Joshimath",
        category: "Mountain",
        vibeType: "Chill",
    ...
    {
        locationName: "Niti Valley Trail",
        anchorCity: "Joshimath",
        category: "Trail",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Chakrata Forest Drive",
        anchorCity: "Dehradun",
        category: "Forest",
        vibeType: "Twisties",
    ...
    // ==========================================
    // --- NEW: NORTH-EAST INDIA & SIKKIM (20)
    // ==========================================
    {
        locationName: "Zuluk 32 Hairpins (Silk Route)",
        anchorCity: "Gangtok",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Gurudongmar Lake Route",
        anchorCity: "Lachen",
        category: "Lake",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Yumthang Valley of Flowers",
        anchorCity: "Lachung",
        category: "Scenic",
        vibeType: "Chill",
    ...
    {
        locationName: "Nathu La Border Pass",
        anchorCity: "Gangtok",
        category: "Mountain",
        vibeType: "Highway",
    ...
    {
        locationName: "Bum La Pass Off-Grid",
        anchorCity: "Tawang",
        category: "Mountain",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Tawang Monastery Curves",
        anchorCity: "Tawang",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Mechuka Valley Trail",
        anchorCity: "Aalo",
        category: "Valley",
        vibeType: "Chill",
    ...
    {
        locationName: "Cherrapunji (Sohra) Wet Drive",
        anchorCity: "Shillong",
        category: "Forest",
        vibeType: "Chill",
    ...
    {
        locationName: "Dawki River Highway",
        anchorCity: "Dawki",
        category: "Coastal",
        vibeType: "Highway",
    ...
    {
        locationName: "Mawsynram Rain Route",
        anchorCity: "Shillong",
        category: "Forest",
        vibeType: "Twisties",
    ...
    {
        locationName: "Kaziranga Highway Corridor",
        anchorCity: "Bokakhat",
        category: "Forest",
        vibeType: "Highway",
    ...
    {
        locationName: "Majuli Island River Ferry",
        anchorCity: "Jorhat",
        category: "River",
        vibeType: "Chill",
    ...
    {
        locationName: "Dzukou Valley Base Trail",
        anchorCity: "Kohima",
        category: "Trail",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Kohima Dimapur Highway",
        anchorCity: "Dimapur",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Loktak Lake Floating Road",
        anchorCity: "Imphal",
        category: "Lake",
        vibeType: "Chill",
        description: "A serene, flat ride alongside the largest freshwater lake in Northeast India, famous for its massive floating circular swamps (phumdis).",
        latitude: 24.5553,
        longitude: 93.8152,
        petrolPump: false,
        images: []
    ...
    {
        locationName: "Moreh Indo-Myanmar Border",
        anchorCity: "Tengnoupal",
        category: "Highway",
        vibeType: "Highway",
    ...
    {
        locationName: "Aizawl Mountain Pass",
        anchorCity: "Aizawl",
        category: "Mountain",
        vibeType: "Twisties",
    ...
    {
        locationName: "Phawngpui Blue Mountain Trail",
        anchorCity: "Lawngtlai",
        category: "Forest",
        vibeType: "OffRoad",
    ...
    {
        locationName: "Unakoti Ancient Rock Route",
        anchorCity: "Kailashahar",
        category: "Trail",
        vibeType: "OffRoad",
